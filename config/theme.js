...
export const gradient = {
  ...
  leftToRight: `linear-gradient(100deg, rgba(131,58,180,1) 0%, rgba(253,29,29,1) 50%, rgba(252,176,69,1) 100%);`,
  // eslint-disable-next-line
  rightToLeft: `linear-gradient(-100deg, rgba(131,58,180,1) 0%, rgba(253,29,29,1) 50%, rgba(252,176,69,1) 100%);`,
};
...
export const theme = {
  ...
  fontFamily: {
    // eslint-disable-next-line
    body: `Courier, Courier Prime, Inconsolata, monospace`,
    // eslint-disable-next-line
    heading: `Courier, Courier Prime, Inconsolata, monospace`,
  },
  layout: {
    article: '46rem',
    base: '70rem',
